...
/** @type {string} */
const CACHE_VERSION = '1785937986|8252422';
/** @type {string} */
...
/** @type {string[]} */
const CACHEABLE_FILES = ["index.wasm","index.pck","index.side.wasm","godot_rapier.wasm","libgdfallingsand.web.template_release.wasm32.wasm"];
